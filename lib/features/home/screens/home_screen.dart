                          ...
                          const Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Lihat & kelola semua pesanan caregivermu',
                                  style: TextStyle(
                                    fontSize: 12,
                        ...
                        const Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              SizedBox(height: 3),
                              Text(
                                'Tanya kebutuhan caregiver pasienmu',
                                style: TextStyle(
                  ...
                  children: [
                    ...
                    _ServiceCard(
                      ...
                      onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (_) => const FamilyHospitalSchedulerScreen(),
                        ),
                      ),
                    ),
                    const SizedBox(width: 12),
                ...
                child: Column(
                  children: [
                    _HowItWorksStep(
                      ...
                      title: 'Pilih Layanan',
                      desc:
                          'Cari caregiver, rumah sakit, atau farmasi terdekat',
                      color: AppColors.primary,
                    ),
                    _HowItWorksStep(
                      step: '2',
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 6),
                        const Text(
                          'Daftar sebagai caregiver dan mulai terima pesanan dari keluarga di sekitarmu.',
                          style: TextStyle(
                            fontSize: 13,
                            color: AppColors.textSecondary,
                            height: 1.4,
